...
class StartHandler:
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if context.args:
            ...
            if movie_id is None:
                await message.reply_text("❌ This download link expired or is invalid. Generate a new link from the bot.")
                return
            ...
            sent = await message.reply_document(
                ...
                caption=(
                    ...
                    "✅ Your movie file has been delivered.\n"
                    "🍿 Enjoy watching!"
                ),
